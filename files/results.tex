...
\subsection{Accuracy and linearity across model-based measurements}
~\label{subsec:linearity_accuracy_model}
To evaluate the accuracy and linearity of the model-based measurements, the calculated diameter values were plotted against the ground truth calculations for each vessel across the three contrast conditions: pre-contrast, peak contrast, and post-contrast (Fig.~\ref{fig:scatter_model}). Six combinations were evaluated: two projection methods (MIP and MeIP) by three model-based width metrics (Gaussian $1/e^2$, GG FWHM, and GG $1/e^2$). A slope of $m = 1$ (black line) indicated perfect agreement with the ground truth, and the coefficient of determination ($R^2$) quantified the goodness of fit of the linear model.
...
For the Gaussian $1/e^2$ width, pre-contrast measurements yielded slopes of $m = 0.70$ ($R^2 = 0.83$) for MIP and $m = 0.73$ ($R^2 = 0.85$) for MeIP, indicating substantial underestimation (Figs.~\ref{fig:scatter_model}a,b). With contrast enhancement, the MIP measurements showed increased slope values, with $m = 1.15$ ($R^2 = 0.88$) at peak contrast and $m = 1.12$ ($R^2 = 0.89$) post-contrast, indicating a slight overestimation of the ground truth. MeIP measurements showed improved accuracy with contrast as well, with $m = 1.04$ ($R^2 = 0.96$) at peak contrast and $m = 1.04$ ($R^2 = 0.98$) post-contrast, also indicating a slight overestimation, but better than the MIP measurements.

The GG FWHM metric consistently returned diameters well below the ground truth, with pre-contrast slopes of $m = 0.42$ (MIP) and $m = 0.43$ (MeIP), peak contrast slopes of $m = 0.66$ (MIP) and $m = 0.61$ (MeIP), and post-contrast slopes of $m = 0.66$ (MIP) and $m = 0.61$ (MeIP) (Figs.~\ref{fig:scatter_model}c,d). The GG $1/e^2$ width provided the best overall performance (Figs.~\ref{fig:scatter_model}e,f). MIP based GG $1/e^2$ measurements showed strong agreement with the ground truth, with $m = 0.98$ ($R^2 = 0.98$) at peak contrast and $m = 1.02$ ($R^2 = 0.93$) post-contrast. MeIP based GG $1/e^2$ measurements showed strong agreement as well, with $m = 0.98$ ($R^2 = 0.97$) at peak contrast and $m = 1.00$ ($R^2 = 0.97$) post-contrast. Pre-contrast MeIP GG $1/e^2$ measurements showed a slope of $m = 0.71$ ($R^2 = 0.88$) which was the highest pre-contrast $R^2$ among all the pre-contrast model evaluated width metrics. Overall, the GG $1/e^2$ width metric provided the most reliable diameter measurements across all contrast conditions, with MeIP generally outperforming MIP.

\subsection{Accuracy and linearity across binary mask based measurements}
~\label{subsec:linearity_accuracy_bw}
Accuracy and linearity analysis was also performed for diameter values measured at the five threshold levels (BW-1 through BW-5) from both the binarised MIP (Fig.~\ref{fig:scatter_bw_mip}) and the binarised MeIP (Fig.~\ref{fig:scatter_bw_meip}).
