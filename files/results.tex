...
\begin{figure}[htbp]
\centering\includegraphics[width=\linewidth,height=\dimexpr\textheight-\pagetotal-8\baselineskip\relax,keepaspectratio]{figures/scatter_model.pdf}
\caption{Modelled versus ground truth vessel diameter using MIP (top row) and MeIP (bottom row). Columns correspond to (a, b) $w_{1/e^2,\,\mathrm{G}}$, (c, d) $\mathrm{FWHM}_{\mathrm{GG}}$, and (e, f) $w_{1/e^2,\,\mathrm{GG}}$. Linear regression lines and statistics are shown for pre-contrast (blue), peak contrast (green), and post-contrast (red) conditions. The black line indicates the identity line ($m = 1$).}
...
\begin{figure}[htbp]
\centering\includegraphics[width=\linewidth,keepaspectratio]{figures/scatter_bw_mip.pdf}
...
\begin{figure}[htbp]
\centering\includegraphics[width=\linewidth,keepaspectratio]{figures/scatter_bw_meip.pdf}
...
\begin{figure}[htbp]
\centering\includegraphics[width=\linewidth,keepaspectratio]{figures/cov_r2.pdf}
...
\begin{figure}[htbp]
\centering\includegraphics[width=\linewidth,height=\dimexpr\textheight-\pagetotal-14\baselineskip\relax,keepaspectratio]{figures/flicker.pdf}
