...
Functional flicker stimulation was performed in a C57BL/6 mouse to assess whether the choice of diameter measurement method affects the detection of physiological vascular responses. For this experiment, ketamine/xylazine cocktail was chosen over isoflurane to minimise anaesthesia-induced vasodilation~\textcolor{red}{[cite]}. During the DyC-OCT acquisition, the retina was unstimulated for approximately 8~seconds, followed by 10~Hz flicker stimulation from the LED ring for the rest of the scan duration.~\textcolor{red}{To compare results before and after stimulation, the data was divided into baseline (pre-stim) and post-stim. Considering time for the OCT signal to stabilise after stimulation, equal time window of four-second at the beginning and end of the scan was selected for pre- and post-stim data respectively.} % (100 samples = 4.1375 seconds)
