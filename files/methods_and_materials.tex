...
\textcolor{red}{Four mice were used in this study. In keeping with the 3Rs of animal research, data from two animals imaged for previously published studies were reused: one very-low-density-lipoprotein receptor (VLDLR) knockout mouse (B6;129S7-\textit{Vldlr}\textsuperscript{tm1Her}/J, The Jackson Laboratory, Bar Harbor, USA)~\cite{augustinMultifunctionalOCTEnables2016}, and one non-transgenic littermate from a superoxide dismutase 1 (SOD1) knockout mouse (JAX stock \#002972, maintained on C57BL/6J)~\cite{augustinOpticalCoherenceTomography2020}. The remaining two animals were C57BL/6J mice (The Jackson Laboratory, Bar Harbor, USA) and were imaged separately for this study.}

\textcolor{red}{Intralipid 20\% (3~mL/kg body weight) was used as a contrast agent and was administered as a bolus injection via the tail vein. A dynamic-contrast OCT (DyC-OCT) protocol~\cite{merkleLaminarMicrovascularTransit2016} was employed during the contrast injection or during stimulation, consisting of 2000 repeated B-scans over approximately 16~seconds (interscan time 8.2~ms) at the same cross-sectional location over a 1~mm lateral field of view. DyC-OCT scans allow us to track the same vessels over time to precisely measure the effects of the contrast agent or the stimulation with a high degree of spatial coregistration. All quantitative vessel diameter measurements reported in this study were derived from the DyC-OCT data. Additionally, volumetric angiography data were acquired over a 1~mm~$\times$~1~mm field of view centred on the optic nerve head (ONH), with a scan density of 500 A-scans per B-scan and five repeated B-scans at each of 400 slow-axis positions (acquisition time approximately 16~seconds). Pre- and post-injection volumetric datasets were acquired and used solely for visualisation purposes.}

\textcolor{red}{Functional flicker stimulation was performed in one of the C57BL/6J mice to assess whether the choice of diameter measurement method affects the detection of physiological vascular responses. During the DyC-OCT acquisition, the retina was unstimulated for approximately 7~seconds, followed by 10~Hz flicker stimulation from the LED ring for the remainder of the scan, approximately 9~seconds. To compare results before and after stimulation, the data were divided into baseline (pre-stim) and post-stim. Considering the time required for the OCT signal to stabilise after stimulation, four-second time windows at the beginning and end of each scan were selected for the pre- and post-stimulation analyses respectively.}

\textcolor{red}{All imaging sessions were conducted under general anaesthesia. Anaesthesia and handling for the VLDLR knockout and SOD1 non-transgenic littermate mice are described in the respective publications~\cite{augustinMultifunctionalOCTEnables2016,augustinOpticalCoherenceTomography2020}. Both C57BL/6J mice were initially induced with isoflurane at 4\% in oxygen for 4~minutes and were subsequently maintained under different anaesthetic combinations. The mouse used for flicker stimulation received a ketamine + xylazine cocktail (100~mg/kg ketamine, 6~mg/kg xylazine; 10~mL/kg body weight), chosen over continued isoflurane to minimise anaesthesia-induced vasodilation~\cite{sullenderDynamicsIsofluraneInduced2022,wormRetinalOCTParameters2026}, while the other mouse received a combination of medetomidine + midazolam + fentanyl + ketamine (MMFK, 10~mL/kg body weight). To maintain core body temperature throughout imaging, the mice were positioned on a heating pad. The pupils were dilated with one drop of tropicamide (5~mg/mL, Agepha Pharma s.r.o., Senec, Slovakia) per eye, and artificial tear drops (Oculotect, ALCON Pharma GmbH, Freiburg im Breisgau, Germany) were applied at regular intervals to prevent corneal drying.}

\textcolor{red}{All animal procedures were approved by the ethics committee of the Medical University of Vienna and the Austrian Federal Ministry of Education, Science, and Research (BMBWF/66.009/0272-V/3b/2019 and GZ 2024-0.802.524).}
...
For each large vessel in the field of view, a rectangular region of interest (ROI) encompassing the vessel cross-section, along the lateral ($x$) and axial ($z$) dimensions, was selected from the DyC-OCT B-scan angiograms.~\textcolor{red}{The ROI was deliberately extended to include a margin of surrounding tissue around the vessel, so that the profile contained a baseline on either side of the vessel for the model fits.} En face angiogram profiles were then generated by projecting the angiogram signal within this ROI along the axial ($z$) direction for all time points. Two projection methods were compared: maximum intensity projection (MIP), which selects the highest intensity value along the depth axis of each ROI, and mean intensity projection (MeIP), which averages the values along each ROI. Each projection resulted in a time-stack of 1-D lateral intensity profiles for each vessel, which were then used for subsequent diameter quantification. 

\subsubsection{Skew correction}
\label{subsubsec:skew_correction}
Off-axis cross-sectioning elongates the vessel along the lateral direction, so the lateral diameter measured from the ROI projection can overestimate the true vessel size. Because the lateral diameter is the quantity studied here, a correction factor of $d_{\mathrm{GT}}/d_x$ was defined from the ground truth diameter. By multiplying this correction factor against the diameter measured from each method, we ensured that the measured vessel diameter reflected the true size of the vessel\textcolor{red}{, without the skew.}
...
\end{equation}
and therefore only the $1/e^2$ width was calculated directly from the fit~\textcolor{red}{and evaluated here}, with the FWHM obtainable via this known relationship.
