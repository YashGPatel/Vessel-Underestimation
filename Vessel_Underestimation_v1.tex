...
\bibliography{sample,Vessel_Underestimation} %include the new ones from Merkle_Master_Library_Copy
% keep only the unique ones into a separate bib file and use two bib files 
